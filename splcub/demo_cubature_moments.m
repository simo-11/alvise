...
function demo_cubature_moments
...
adeV=10;   % algebraic degree of precision
...
for ii=1:length(adeV)
    ...
    % ..................... reference routine .............................
    [nodes_x,nodes_y,weights]=splinegauss_2009b(n,polygon_sides,...
...
fprintf('\n  ME_s.cub : momerr splcub');
fprintf('\n  ME_s.gss : momerr splgauss');
fprintf('\n  -----------------------------------------------------------');
...
switch example
    ...
    case 1
        ...
        spline_order_vett=[8 5; 4 size(polygon_sides,1)];
