...
function demo_cubature_properties_2019

% This demo:
% * tests the performance of our new rules of degree ADE, on spline 
%   curvilinear domains, describing their properties
...
fprintf('\n \n')
fprintf('\n  ----------------------------------------------------------------------------------');
fprintf('\n  |  ade |  card | in card |   cond   |   moms   |    cpu    | ');
fprintf('\n  ----------------------------------------------------------------------------------');

% statistics: experiments
for ii=1:length(adeV)
    fprintf('\n  | %3.0f  | %5.0f  | %5.0f  | %1.1e  | %1.1e |  %1.1e  |',...
        adeV(ii), card_2019(ii),in_2019(ii),cond2019(ii),momsres(ii),cputiming(ii));
end
